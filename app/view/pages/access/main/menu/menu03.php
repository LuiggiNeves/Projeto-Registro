<!-- Modal para mostrar detalhes do cartão -->
<div id="cardDetailsModal" class="Card_Details_Modal" style="display: none;">
    <div class="Card_Details_Content">
        ...
        <p><strong>Arquivos:</strong> <span id="detailArquivos"></span></p> <!-- Nova linha para arquivos -->
