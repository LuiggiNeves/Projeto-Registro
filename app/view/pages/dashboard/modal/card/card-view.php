<!-- Modal for View -->
<div class="card-modal" id="viewModal" onclick="closeModalOnOutsideClick(event, 'viewModal')">
            ...
            <div class="Container_Body_Modal">
                <div class="modal-info">
                    ...
                    <div class="container-infos-arquivos">
                        <div class="infos-download-conversa text-center">
                            <div>
                                <h6>Conversa com o fornecedor</h6>
                            </div>
                            <a href="#">Baixar</a></br>
                            <a href="#">Transcrita</a>
                        </div>
